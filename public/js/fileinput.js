...
(function ($) {
    ...
    '    </div>\n' +
    '</div>';
    tClose = '<div class="close fileinput-remove"><i class="fa fa-times text-danger" aria-hidden="true"></i></div>\n';
    tIcon = '<span class="fa fa-check-circle"></span>';
...
//FileInput plugin definition
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileExtension: 'Extensión inválida para archivo "{name}". Solo "{extensions}" archivos permitidos.',
